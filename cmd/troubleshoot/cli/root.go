...
from a server that can be used to assist when troubleshooting a Kubernetes cluster.`,
	...
	cmd.Flags().Bool("load-cluster-specs", false, "enable/disable loading additional troubleshoot specs found in secrets within the cluster. required when no specs are provided on the command line")
