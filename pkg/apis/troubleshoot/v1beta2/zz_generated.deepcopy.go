...
func (in *Goldpinger) DeepCopyInto(out *Goldpinger) {
	*out = *in
	in.CollectorMeta.DeepCopyInto(&out.CollectorMeta)
	in.PodLaunchSpec.DeepCopyInto(&out.PodLaunchSpec)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodLaunchSpec) DeepCopyInto(out *PodLaunchSpec) {
	*out = *in
	if in.ImagePullSecret != nil {
		in, out := &in.ImagePullSecret, &out.ImagePullSecret
		*out = new(ImagePullSecrets)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodLaunchSpec.
func (in *PodLaunchSpec) DeepCopy() *PodLaunchSpec {
	if in == nil {
		return nil
	}
	out := new(PodLaunchSpec)
	in.DeepCopyInto(out)
	return out
}
