...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteSysctl) DeepCopyInto(out *RemoteSysctl) {
	*out = *in
	in.RemoteCollectorMeta.DeepCopyInto(&out.RemoteCollectorMeta)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteSysctl.
func (in *RemoteSysctl) DeepCopy() *RemoteSysctl {
	if in == nil {
		return nil
	}
	out := new(RemoteSysctl)
