...
func (in *AfterCollection) DeepCopyInto(out *AfterCollection) {
	*out = *in
	...
	if in.UploadToReplicated != nil {
		in, out := &in.UploadToReplicated, &out.UploadToReplicated
		*out = new(UploadToReplicatedSpec)
		**out = **in
	}
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UploadToReplicatedSpec) DeepCopyInto(out *UploadToReplicatedSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UploadToReplicatedSpec.
func (in *UploadToReplicatedSpec) DeepCopy() *UploadToReplicatedSpec {
	if in == nil {
		return nil
	}
	out := new(UploadToReplicatedSpec)
