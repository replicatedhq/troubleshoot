...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LLMAnalyze) DeepCopyInto(out *LLMAnalyze) {
	*out = *in
	in.AnalyzeMeta.DeepCopyInto(&out.AnalyzeMeta)
	if in.Outcomes != nil {
		in, out := &in.Outcomes, &out.Outcomes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LLMAnalyze.
func (in *LLMAnalyze) DeepCopy() *LLMAnalyze {
	if in == nil {
		return nil
	}
	out := new(LLMAnalyze)
