...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostCertificates) DeepCopyInto(out *HostCertificates) {
	*out = *in
	in.HostCollectorMeta.DeepCopyInto(&out.HostCollectorMeta)
	if in.Paths != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostCertificates.
func (in *HostCertificates) DeepCopy() *HostCertificates {
	if in == nil {
		return nil
	}
	out := new(HostCertificates)
	in.DeepCopyInto(out)
	return out
}
