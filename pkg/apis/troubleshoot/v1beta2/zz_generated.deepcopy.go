...
func (in *HostAnalyze) DeepCopyInto(out *HostAnalyze) {
	*out = *in
	...
	if in.XFSInfo != nil {
		in, out := &in.XFSInfo, &out.XFSInfo
		*out = new(XFSInfoAnalyze)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *XFSInfo) DeepCopyInto(out *XFSInfo) {
	*out = *in
	out.HostCollectorMeta = in.HostCollectorMeta
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new XFSInfo.
func (in *XFSInfo) DeepCopy() *XFSInfo {
	if in == nil {
		return nil
	}
	out := new(XFSInfo)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *XFSInfoAnalyze) DeepCopyInto(out *XFSInfoAnalyze) {
	*out = *in
	out.AnalyzeMeta = in.AnalyzeMeta
	if in.Outcomes != nil {
		in, out := &in.Outcomes, &out.Outcomes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new XFSInfoAnalyze.
func (in *XFSInfoAnalyze) DeepCopy() *XFSInfoAnalyze {
	if in == nil {
		return nil
	}
	out := new(XFSInfoAnalyze)
