...
func (in *Analyze) DeepCopyInto(out *Analyze) {
	*out = *in
	...
	if in.RookStatus != nil {
		in, out := &in.RookStatus, &out.RookStatus
		*out = new(RookStatus)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RookFilters) DeepCopyInto(out *RookFilters) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RookFilters.
func (in *RookFilters) DeepCopy() *RookFilters {
	if in == nil {
		return nil
	}
	out := new(RookFilters)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RookStatus) DeepCopyInto(out *RookStatus) {
	*out = *in
	out.AnalyzeMeta = in.AnalyzeMeta
	if in.Outcomes != nil {
		in, out := &in.Outcomes, &out.Outcomes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RookStatus.
func (in *RookStatus) DeepCopy() *RookStatus {
	if in == nil {
		return nil
	}
	out := new(RookStatus)
