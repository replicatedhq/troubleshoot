	...
	tests := []struct {
		...
		},
		{
			...
			expectResult: AnalyzeResult{
				...
				IsFail:  false,
				Title:   "Ceph Status",
				Message: "Ceph status is HEALTH_WARN: OSD is nearly full: PG usage is 85.0%",
		...
		},
		{
			...
			expectResult: AnalyzeResult{
				...
				IsFail:  true,
				Title:   "Ceph Status",
				Message: "Ceph status is HEALTH_ERR: OSD is full: PG usage is 95.0%",
				URI:     "https://rook.io/docs/rook/v1.4/ceph-common-issues.html",
				IconKey: "rook",
				IconURI: "https://troubleshoot.sh/images/analyzer-icons/rook.svg?w=11&h=16",
			},
		...
		},
		{
			...
			expectResult: AnalyzeResult{
				...
				IsFail:  true,
				Title:   "Ceph Status",
				Message: "custom message WARN: OSD is nearly full: PG usage is 85.0%",
				URI:     "custom uri WARN",
				IconKey: "rook",
				IconURI: "https://troubleshoot.sh/images/analyzer-icons/rook.svg?w=11&h=16",
			},
		...
		{
			name:     "warn case with missing osc/pg data",
			analyzer: troubleshootv1beta2.CephStatusAnalyze{},
			expectResult: AnalyzeResult{
				IsPass:  false,
				IsWarn:  true,
