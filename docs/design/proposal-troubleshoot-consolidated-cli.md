...
For the purposes of this design global flags here are limited to the ones we set ourselves. it is expected that the CLI will import some flags from kubectl.
